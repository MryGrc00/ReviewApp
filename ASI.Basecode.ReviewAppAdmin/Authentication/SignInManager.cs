...
using ASI.Basecode.ReviewAppAdmin.Extensions.Configuration;
...
namespace ASI.Basecode.ReviewAppAdmin.Authentication
{
    /// <summary>
    /// SignInManager
    /// </summary>
    public class SignInManager
    {
        ...
        public ClaimsIdentity CreateClaimsIdentity(Admin user)
        {
        ...
        public async Task SignInAsync(Admin user, bool isPersistent = false)
        {
